...
const PRINTER_FIELDS: Record<
  PrinterType,
  Array<{ name: string; label: string; placeholder: string; type?: string }>
> = {
  bambu: [
...
export const PrinterManager = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold mb-2">Active Printers</h2>
        ...
        <div className="space-y-2">
          ...
          {printers?.length === 0 && (
            <div className="text-sm text-gray-500">No printers added yet.</div>
          )}
        </div>
      </div>
      <div>
